...
public class RedisConstant {
    ...
    public static final String CACHE_BLOG_TOP_KEY = "cache:footer:top";
    ...
    public static final String CACHE_BLOG_INFO_KEY = "cache:blog:info:";
    public static final Long CACHE_BLOG_INFO_TTL = 86400L;

    public static final String TIMED_TASK_BLOG_VIEW = "timed:blog:view";
}
