<template>
    <ContentFieldCom>
        <div class="ui container animated fadeIn"  style="min-width: 60vw" >
            ...
            <div class="ui top attached segment" align="center">
                <img src="@/assets/img/img2.jpg" alt="" class="ui rounded rounded image" style="width: 800px; height: 450px">
            </div>
            <!--头部-->
            <div class="ui attached segment">
                <div class="ui horizontal link list">
                    <div class="item">
                        ...
                        <div class="content"><a href="#" target="_blank" class="header"  >xiu du</a></div>
                    </div>
                    <div class="item">
            ...
            <div class="ui attached padded segment ">
                ...
                <br>
                <div id="content" class="typo typo-selection m-padded-lr-responsive m-padded-tb js-toc-content">
    ...
    .typo p, .typo pre, .typo ul, .typo ol, .typo dl, .typo form, .typo hr {
        margin:1em 0 0.6em;
            ...
            <!--分类-->
            <div class="ui attached padded segment">
                <div class="ui basic teal label" >这是分类</div>
            </div>
            ...
            <div class="ui attached positive message">
                <div class="ui middle aligned divided grid">
                    ...
                    <div class="thirteen wide column" style="color: black">
                        <ui class="list">
                            <li>作者：<span>锈渎</span></li>
                            <li>发布时间：<span>2023-05-26</span></li>
                            <li>更新时间：<span>2023-05-26</span></li>
                        </ui>
            ...
            <!--评论区域-->
            <div id="comment-content" class="ui bottom attached segment">
            ...
            <!--留言区域-->
            <div id="comment-form" class="ui form bottom segment">
                <input type="hidden" name="blogId">
                <input type="hidden" name="parentId">
                <input type="hidden" name="topCommentId">
                <div class="field">
                    <label>
                        <textarea name="content" placeholder="与人善言，暖于布帛；伤人以言，深于矛戟..."></textarea>
                    </label>
                </div>
                <div class="fields">
    ...
    <div class="ui vertical icon buttons m-padded-tb-large m-fixed m-right-bottom">
        ...
        <div id="comment-button" class="ui teal button" @click="click_comment_button">评论</div>
        <div id="comment-reply" class="ui teal button" @click="click_comment_reply">留言</div>
